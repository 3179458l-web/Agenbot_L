...
/* ── AI-Thinker ESP32-CAM Pin 定义 ────────────────────────── */
#define CAM_PIN_PWDN    32
#define CAM_PIN_RESET   -1   /* 无硬件 RESET */
...
esp_err_t camera_init(void)
{
    ...
    ESP_LOGI(TAG, "Camera ready: VGA 640x480, JPEG quality=%d", config.jpeg_quality);
    return ESP_OK;
}
